...
Example:
Rscript calculate_misassignment.R  'mouse' \
	'01_HMR,02_HMR,03_HMR,04_HMR' \
	'human,mouse,rat' \
	'09_Pc,10_Pc,11_Pc,12_Pc,05_EC,06_EC,07_EC,08_EC' \
	'rat;rat;rat;rat;human;human;human;human' \
	0 \
	'/home/xinhe/Projects/bbb_pbaxter/misassignment/gene_length.csv' \
	'/home/xinhe/Projects/bbb_pbaxter/results/sargasso/filtered_reads/overall_filtering_summary.txt' \
	'/home/xinhe/Projects/bbb_pbaxter/results/read_counts/' \
...
More details of the algorithm is described in https://www.nature.com/articles/s41596-018-0029-2
...
res$D %>% as.data.frame() %>% write.csv(file.path(result_dir,'target_sample_RNA_ratio.csv'),)
