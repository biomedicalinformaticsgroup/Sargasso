...
def test_filter_sample_reads_pe_chipseq(tmpdir):
    args = ["dnaseq",
            ...
            tmpdir.mkdir("chipseq_test_pe").join("bisulfite_human_pe_sample_mouse_0_filtered.bam").strpath,
            "human",
            resource_filename("tests.data.pe.chipseq.filtered_reads.Blocks",
                              "bisulfite_human_pe_sample___human___BLOCK___1.bam"),
            tmpdir.join("chipseq_test_pe/bisulfite_human_pe_sample_human_0_filtered.bam").strpath,
            "rat",
            resource_filename("tests.data.pe.chipseq.filtered_reads.Blocks",
                              "bisulfite_human_pe_sample___rat___BLOCK___1.bam"),
            tmpdir.join("chipseq_test_pe/bisulfite_human_pe_sample_rat_0_filtered.bam").strpath
            ]

    get_data_type_manager(['dnaseq'], SampleFilterer.DOC).get_sample_filterer().run(args)

    mouse_out = tmpdir.join("chipseq_test_pe/bisulfite_human_pe_sample_human_0_filtered.bam").strpath
    rat_out = tmpdir.join("chipseq_test_pe/bisulfite_human_pe_sample_human_0_filtered.bam").strpath
    human_out = tmpdir.join("chipseq_test_pe/bisulfite_human_pe_sample_human_0_filtered.bam").strpath
