...
MOUSE_FILTERED_HITS_EXPECTED=$4
MOUSE_FILTERED_READS_EXPECTED=$5
MOUSE_REJECTED_HITS_EXPECTED=$6
MOUSE_REJECTED_READS_EXPECTED=$7

RAT_FILTERED_HITS_EXPECTED=$8
RAT_FILTERED_READS_EXPECTED=$9
RAT_REJECTED_HITS_EXPECTED=${10}
RAT_REJECTED_READS_EXPECTED=${11}

AMBIGUOUS_HITS_EXPECTED=${12}
AMBIGUOUS_READS_EXPECTED=${13}
...
species_separator --reads-base-dir="/" --s1-index=${MOUSE_STAR_INDEX} --s2-index=${RAT_STAR_INDEX} -t ${NUM_THREADS} --mismatch-threshold=${MISMATCH_THRESHOLD} --minmatch-threshold=${MINMATCH_THRESHOLD} --multimap-threshold=${MULTIMAP_THRESHOLD} mouse rat ${SAMPLES_FILE} ${SSS_DIR}
